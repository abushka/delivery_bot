...
category_format_string = "<b>{name}</b>\n" \
...
# Select a product to assigment to Category
menu_category_assignment = "✏️ Какому продукту хотите назначить категорию ?"
...
ask_product_category = "Какую категорию назначим продукту ?"
...
ask_product_category = "Выберите категорию товаров, которые хотите приобрести"

ask_product_category_with_page = "Выберите категорию товаров, которые хотите приобрести\n" \
